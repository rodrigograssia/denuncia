...
function Footer({ fixed = false }) {
  const wrapperClass = fixed ? 'fixed bottom-0 left-0 w-full z-50' : 'w-full mt-auto';

  return (
    <footer className={`${wrapperClass} bg-[#eeeeee] dark:bg-neutral-900 py-4 px-4 md:py-5 md:px-8`}>
