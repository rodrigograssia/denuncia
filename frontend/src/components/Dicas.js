                ...
                <div className="grid grid-cols-2 gap-6 lg:grid-cols-3 w-full mx-auto"> 
                    {dicas.map((dica, idx) => (
                        <div
                            ...
                            <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-white font-bold text-xl opacity-100 transition-opacity duration-300 group-hover:opacity-0">
                                Clique para ver a dica
                            </div>
                          
                            <div
                                className="absolute inset-0 bg-white dark:bg-neutral-700 flex items-center justify-center p-3 md:p-6 rounded-lg shadow-inner opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                <p className="text-gray-800 dark:text-neutral-300 font-semibold text-base md:text-2xl lg:text-xl leading-relaxed text-center">
                                    {dica}
                                </p>
                            </div>
                        </div>
